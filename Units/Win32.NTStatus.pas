...
const
    ...
    // Facility $17 is reserved and used in isolation lib as
    //             PIE=$17:FACILITY_MANIFEST_ERROR_CODE
    ...
    // FacilityCodes $5 - $F have been allocated by various drivers.
    ...
    STATUS_ABANDONED_WAIT_0 = $00000080;    // winnt
    ...
    STATUS_USER_APC = $000000C0;    // winnt
    ...
    STATUS_VALID_IMAGE_HASH = $0000012C;
    ...
    STATUS_VALID_CATALOG_HASH = $0000012D;
    ...
    STATUS_VALID_STRONG_CODE_HASH = $0000012E;
    ...
    STATUS_DATA_OVERWRITTEN = $00000130;
    ...
    DBG_EXCEPTION_HANDLED = $00010001;    // winnt
    ...
    STATUS_SEGMENT_NOTIFICATION = $40000005;    // winnt
    ...
    STATUS_FATAL_APP_EXIT = $40000015;    // winnt
    ...
    STATUS_FT_READ_FROM_COPY = $40000035;
    ...
    STATUS_IMAGE_AT_DIFFERENT_BASE = $40000036;
    ...
    DBG_REPLY_LATER = $40010001;    // winnt
    ...
    DBG_TERMINATE_THREAD = $40010003;    // winnt
    ...
    DBG_TERMINATE_PROCESS = $40010004;    // winnt
    ...
    DBG_PRINTEXCEPTION_C = $40010006;    // winnt
    ...
    DBG_RIPEXCEPTION = $40010007;    // winnt
    ...
    DBG_CONTROL_BREAK = $40010008;    // winnt
    ...
    DBG_COMMAND_EXCEPTION = $40010009;    // winnt
    ...
    DBG_PRINTEXCEPTION_WIDE_C = $4001000A;    // winnt
    ...
    // Note:  Do NOT use the value $80000000L, as this is a non-portable value
    ...
    STATUS_GUARD_PAGE_VIOLATION = $80000001;    // winnt
    ...
    STATUS_DATATYPE_MISALIGNMENT = $80000002;    // winnt
    ...
    STATUS_BREAKPOINT = $80000003;    // winnt
    ...
    STATUS_SINGLE_STEP = $80000004;    // winnt
    ...
    STATUS_LONGJUMP = $80000026;    // winnt
    ...
    STATUS_UNWIND_CONSOLIDATE = $80000029;    // winnt
    ...
    STATUS_DEVICE_SUPPORT_IN_PROGRESS = $80000030;
    ...
    STATUS_DEVICE_POWER_CYCLE_REQUIRED = $80000031;
    ...
    DBG_EXCEPTION_NOT_HANDLED = $80010001;    // winnt
...
(*++
 ...
 MessageId's $cf00 - $cfff (inclusive) are for Cloud Files specific warning messages.
...
--*)
    ...
    STATUS_CLOUD_FILE_PROPERTY_BLOB_CHECKSUM_MISMATCH = $8000CF00;
...
--*)
    ...
    STATUS_INVALID_INFO_CLASS = $C0000003;    // ntsubauth
    ...
    // The instruction at $%p referenced memory at $%p. The memory could not be %s.

    STATUS_ACCESS_VIOLATION = $C0000005;    // winnt
    ...
    // The instruction at $%p referenced memory at $%p. The required data was not placed into memory because of an I/O error status of $%x.

    STATUS_IN_PAGE_ERROR = $C0000006;    // winnt
    ...
    STATUS_INVALID_PARAMETER = $C000000D;    // winnt
    ...
    STATUS_ILLEGAL_INSTRUCTION = $C000001D;    // winnt
    ...
    STATUS_NONCONTINUABLE_EXCEPTION = $C0000025;    // winnt
    ...
    STATUS_INVALID_DISPOSITION = $C0000026;    // winnt
    ...
    STATUS_PORT_DO_NOT_DISTURB = $C0000036;
    ...
    STATUS_NO_SUCH_USER = $C0000064;     // ntsubauth
    ...
    STATUS_WRONG_PASSWORD = $C000006A;     // ntsubauth
    ...
    STATUS_PASSWORD_RESTRICTION = $C000006C;     // ntsubauth
    ...
    STATUS_LOGON_FAILURE = $C000006D;     // ntsubauth
    ...
    STATUS_ACCOUNT_RESTRICTION = $C000006E;     // ntsubauth
    ...
    STATUS_INVALID_LOGON_HOURS = $C000006F;     // ntsubauth
    ...
    STATUS_INVALID_WORKSTATION = $C0000070;     // ntsubauth
    ...
    STATUS_PASSWORD_EXPIRED = $C0000071;     // ntsubauth
    ...
    STATUS_ACCOUNT_DISABLED = $C0000072;     // ntsubauth
    ...
    // {Bad Image}
    // %hs is either not designed to run on Windows or it contains an error. Try installing the program again using the original installation media or contact your system administrator or the software vendor for support. Error status $%08lx.
    ...
    STATUS_ARRAY_BOUNDS_EXCEEDED = $C000008C;    // winnt
    ...
    STATUS_FLOAT_DENORMAL_OPERAND = $C000008D;    // winnt
    ...
    STATUS_FLOAT_DIVIDE_BY_ZERO = $C000008E;    // winnt
    ...
    STATUS_FLOAT_INEXACT_RESULT = $C000008F;    // winnt
    ...
    STATUS_FLOAT_INVALID_OPERATION = $C0000090;    // winnt
    ...
    STATUS_FLOAT_OVERFLOW = $C0000091;    // winnt
    ...
    STATUS_FLOAT_STACK_CHECK = $C0000092;    // winnt
    ...
    STATUS_FLOAT_UNDERFLOW = $C0000093;    // winnt
    ...
    STATUS_INTEGER_DIVIDE_BY_ZERO = $C0000094;    // winnt
    ...
    STATUS_INTEGER_OVERFLOW = $C0000095;    // winnt
    ...
    STATUS_PRIVILEGED_INSTRUCTION = $C0000096;    // winnt
    ...
    STATUS_INSUFFICIENT_RESOURCES = $C000009A;     // ntsubauth
    ...
    STATUS_STACK_OVERFLOW = $C00000FD;    // winnt
    ...
    STATUS_DLL_NOT_FOUND = $C0000135;    // winnt
    ...
    STATUS_ORDINAL_NOT_FOUND = $C0000138;    // winnt
    ...
    STATUS_ENTRYPOINT_NOT_FOUND = $C0000139;    // winnt
    ...
    STATUS_CONTROL_C_EXIT = $C000013A;    // winnt
    ...
    STATUS_DLL_INIT_FAILED = $C0000142;    // winnt
    ...
    // {Application Error}
    // The exception %s ($%08lx) occurred in the application at location $%p.
    ...
    // An illegal character was encountered. For a multi-byte character set this includes a lead byte without a succeeding trail byte. For the Unicode character set this includes the characters $FFFF and $FFFE.
    ...
    STATUS_ACCOUNT_EXPIRED = $C0000193;    // ntsubauth
    ...
    STATUS_INVALID_EXCEPTION_HANDLER = $C00001A5;
    ...
    STATUS_NOT_ALLOWED_ON_SYSTEM_FILE = $C00001A7;
    ...
    STATUS_QUOTA_NOT_ENABLED = $C00001A9;
    ...
    STATUS_FILE_METADATA_OPTIMIZATION_IN_PROGRESS = $C00001AB;
    ...
    STATUS_FATAL_MEMORY_EXHAUSTION = $C00001AD;
    ...
    STATUS_ERROR_PROCESS_NOT_IN_JOB = $C00001AE;
    ...
    STATUS_CPU_SET_INVALID = $C00001AF;
    ...
    STATUS_PASSWORD_MUST_CHANGE = $C0000224;    // ntsubauth
    ...
    STATUS_ACCOUNT_LOCKED_OUT = $C0000234;    // ntsubauth
    ...
    STATUS_STOWED_EXCEPTION = $C000027B;
    ...
    STATUS_CONTEXT_STOWED_EXCEPTION = $C000027C;
    ...
    STATUS_FLOAT_MULTIPLE_FAULTS = $C00002B4;    // winnt
    ...
    STATUS_FLOAT_MULTIPLE_TRAPS = $C00002B5;    // winnt
    ...
    STATUS_DS_RIDMGR_DISABLED = $C00002BA;
    ...
    STATUS_REG_NAT_CONSUMPTION = $C00002C9;    // winnt
    ...
    STATUS_PASSWORD_CHANGE_REQUIRED = $C000030C;
    ...
    STATUS_LOST_MODE_LOGON_RESTRICTION = $C000030D;

(*++

 MessageId's $030e - $031f (inclusive) are reserved for future **STORAGE**
...
(*++
 ...
 MessageId's $0323 - $034f (inclusive) are reserved for other future copy
 protection errors.
...
--*)
    ...
    STATUS_HEAP_CORRUPTION = $C0000374;    // winnt
    ...
    (* MessageId up to $400 is reserved for smart cards *)
    ...
    STATUS_STACK_BUFFER_OVERRUN = $C0000409;    // winnt
    ...
    STATUS_INVALID_CRUNTIME_PARAMETER = $C0000417;    // winnt
    ...
    STATUS_ASSERTION_FAILURE = $C0000420;    // winnt
    ...
    // MessageId $042E is reserved and used in isolation lib as

    // MessageId=$042E Facility=System Severity=ERROR SymbolicName=STATUS_VERSION_PARSE_ERROR
    // Language=English
    ...
    STATUS_INVALID_SESSION = $C0000455;
    ...
    STATUS_THREAD_ALREADY_IN_SESSION = $C0000456;
    ...
    STATUS_THREAD_NOT_IN_SESSION = $C0000457;
    ...
    STATUS_INVALID_WEIGHT = $C0000458;
    ...
    STATUS_REQUEST_PAUSED = $C0000459;
    ...
    STATUS_DISK_RESOURCES_EXHAUSTED = $C0000461;
    ...
    STATUS_NEEDS_REMEDIATION = $C0000462;
    ...
    STATUS_DEVICE_INSUFFICIENT_RESOURCES = $C0000468;
    ...
    STATUS_PACKAGE_UPDATING = $C0000469;
    ...
    STATUS_NOT_READ_FROM_COPY = $C000046A;
    ...
    STATUS_FT_WRITE_FAILURE = $C000046B;
    ...
    STATUS_FT_DI_SCAN_REQUIRED = $C000046C;
    ...
    STATUS_OBJECT_NOT_EXTERNALLY_BACKED = $C000046D;
    ...
    STATUS_EXTERNAL_BACKING_PROVIDER_UNKNOWN = $C000046E;
    ...
    STATUS_DATA_CHECKSUM_ERROR = $C0000470;
    ...
    STATUS_INTERMIXED_KERNEL_EA_OPERATION = $C0000471;
    ...
    STATUS_TRIM_READ_ZERO_NOT_SUPPORTED = $C0000472;
    ...
    STATUS_TOO_MANY_SEGMENT_DESCRIPTORS = $C0000473;
    ...
    STATUS_INVALID_OFFSET_ALIGNMENT = $C0000474;
    ...
    STATUS_INVALID_FIELD_IN_PARAMETER_LIST = $C0000475;
    ...
    STATUS_INVALID_INITIATOR_TARGET_PATH = $C0000477;
    ...
    STATUS_SCRUB_DATA_DISABLED = $C0000478;
    ...
    STATUS_NOT_REDUNDANT_STORAGE = $C0000479;
    ...
    STATUS_RESIDENT_FILE_NOT_SUPPORTED = $C000047A;
    ...
    STATUS_COMPRESSED_FILE_NOT_SUPPORTED = $C000047B;
    ...
    STATUS_DIRECTORY_NOT_SUPPORTED = $C000047C;
    ...
    STATUS_IO_OPERATION_TIMEOUT = $C000047D;
    ...
    STATUS_SYSTEM_NEEDS_REMEDIATION = $C000047E;
    ...
    STATUS_APPX_INTEGRITY_FAILURE_CLR_NGEN = $C000047F;
    ...
    STATUS_APISET_NOT_HOSTED = $C0000481;
    ...
    STATUS_APISET_NOT_PRESENT = $C0000482;
    ...
    STATUS_DEVICE_HARDWARE_ERROR = $C0000483;
    ...
    STATUS_FIRMWARE_SLOT_INVALID = $C0000484;
    ...
    STATUS_FIRMWARE_IMAGE_INVALID = $C0000485;
    ...
    STATUS_STORAGE_TOPOLOGY_ID_MISMATCH = $C0000486;
    ...
    STATUS_WIM_NOT_BOOTABLE = $C0000487;
    ...
    STATUS_BLOCKED_BY_PARENTAL_CONTROLS = $C0000488;
    ...
    STATUS_NEEDS_REGISTRATION = $C0000489;
    ...
    STATUS_QUOTA_ACTIVITY = $C000048A;
    ...
    STATUS_CALLBACK_INVOKE_INLINE = $C000048B;
    ...
    STATUS_BLOCK_TOO_MANY_REFERENCES = $C000048C;
    ...
    STATUS_MARKED_TO_DISALLOW_WRITES = $C000048D;
    ...
    STATUS_NETWORK_ACCESS_DENIED_EDP = $C000048E;
    ...
    STATUS_ENCLAVE_FAILURE = $C000048F;
    ...
    STATUS_PNP_NO_COMPAT_DRIVERS = $C0000490;
    ...
    STATUS_PNP_DRIVER_PACKAGE_NOT_FOUND = $C0000491;
    ...
    STATUS_PNP_DRIVER_CONFIGURATION_NOT_FOUND = $C0000492;
    ...
    STATUS_PNP_DRIVER_CONFIGURATION_INCOMPLETE = $C0000493;
    ...
    STATUS_PNP_FUNCTION_DRIVER_REQUIRED = $C0000494;
    ...
    STATUS_PNP_DEVICE_CONFIGURATION_PENDING = $C0000495;
    ...
    STATUS_DEVICE_HINT_NAME_BUFFER_TOO_SMALL = $C0000496;
    ...
    STATUS_PACKAGE_NOT_AVAILABLE = $C0000497;
    ...
    STATUS_DEVICE_IN_MAINTENANCE = $C0000499;
    ...
    STATUS_NOT_SUPPORTED_ON_DAX = $C000049A;
    ...
    STATUS_FREE_SPACE_TOO_FRAGMENTED = $C000049B;
    ...
    STATUS_DAX_MAPPING_EXISTS = $C000049C;
    ...
    STATUS_CHILD_PROCESS_BLOCKED = $C000049D;
    ...
    STATUS_STORAGE_LOST_DATA_PERSISTENCE = $C000049E;
    ...
    STATUS_VRF_CFG_ENABLED = $C000049F;
    ...
    STATUS_PARTITION_TERMINATING = $C00004A0;
    ...
    STATUS_EXTERNAL_SYSKEY_NOT_SUPPORTED = $C00004A1;
    ...
    STATUS_ENCLAVE_VIOLATION = $C00004A2;    // winnt
    ...
    STATUS_FILE_PROTECTED_UNDER_DPL = $C00004A3;
    ...
    STATUS_VOLUME_NOT_CLUSTER_ALIGNED = $C00004A4;
    ...
    STATUS_NO_PHYSICALLY_ALIGNED_FREE_SPACE_FOUND = $C00004A5;
    ...
    STATUS_APPX_FILE_NOT_ENCRYPTED = $C00004A6;
    ...
    STATUS_RWRAW_ENCRYPTED_FILE_NOT_ENCRYPTED = $C00004A7;
    ...
    STATUS_RWRAW_ENCRYPTED_INVALID_EDATAINFO_FILEOFFSET = $C00004A8;
    ...
    STATUS_RWRAW_ENCRYPTED_INVALID_EDATAINFO_FILERANGE = $C00004A9;
    ...
    STATUS_RWRAW_ENCRYPTED_INVALID_EDATAINFO_PARAMETER = $C00004AA;
    ...
    STATUS_UNDEFINED_SCOPE = $C0000504;
    ...
    STATUS_DEVICE_UNRESPONSIVE = $C000050A;
    ...
    STATUS_REPARSE_POINT_ENCOUNTERED = $C000050B;
    ...
    STATUS_ATTRIBUTE_NOT_PRESENT = $C000050C;
    ...
    STATUS_NOT_A_TIERED_VOLUME = $C000050D;
    ...
    STATUS_ALREADY_HAS_STREAM_ID = $C000050E;
    ...
    STATUS_ENCLAVE_NOT_TERMINATED = $C0000511;
    ...
    STATUS_ENCLAVE_IS_TERMINATING = $C0000512;
    ...
    STATUS_SMB1_NOT_AVAILABLE = $C0000513;
    ...
    STATUS_SMR_GARBAGE_COLLECTION_REQUIRED = $C0000514;
    ...
    STATUS_DYNAMIC_CODE_BLOCKED = $C0000604;
    ...
    STATUS_IMAGE_CERT_EXPIRED = $C0000605;
    ...
    STATUS_STRICT_CFG_VIOLATION = $C0000606;
    ...
    STATUS_SET_CONTEXT_DENIED = $C000060A;
    ...
    STATUS_CROSS_PARTITION_VIOLATION = $C000060B;
    ...
    // After a callback to $%p($%p), a completion call to SetEvent($%p) failed with status $%08x.
    ...
    // After a callback to $%p($%p), an completion call to FreeLibrary(%p) failed with status $%08x.
    ...
    // The threadpool $%p was released while a thread was posting a callback to $%p($%p) to it.
    ...
    // A threadpool worker thread is impersonating a client, after a callback to $%p($%p).
    ...
    // A threadpool worker thread enter a callback at thread base priority $%x and exited at priority $%x.
    ...
    STATUS_LPC_HANDLE_COUNT_EXCEEDED = $C0000722;
    ...
    STATUS_EXECUTABLE_MEMORY_WRITE = $C0000723;
    ...
    STATUS_KERNEL_EXECUTABLE_MEMORY_WRITE = $C0000724;
    ...
    STATUS_ATTACHED_EXECUTABLE_MEMORY_WRITE = $C0000725;
    ...
    STATUS_TRIGGERED_EXECUTABLE_MEMORY_WRITE = $C0000726;
    ...
    STATUS_DISK_REPAIR_REDIRECTED = $40000807;
    ...
    STATUS_DISK_REPAIR_UNSUCCESSFUL = $C0000808;
    ...
    STATUS_CORRUPT_LOG_OVERFULL = $C0000809;
    ...
    STATUS_CORRUPT_LOG_CORRUPTED = $C000080A;
    ...
    STATUS_CORRUPT_LOG_UNAVAILABLE = $C000080B;
    ...
    STATUS_CORRUPT_LOG_DELETED_FULL = $C000080C;
    ...
    STATUS_CORRUPT_LOG_CLEARED = $C000080D;
    ...
    STATUS_ORPHAN_NAME_EXHAUSTED = $C000080E;
    ...
    STATUS_PROACTIVE_SCAN_IN_PROGRESS = $C000080F;
    ...
    STATUS_ENCRYPTED_IO_NOT_POSSIBLE = $C0000810;
    ...
    STATUS_CORRUPT_LOG_UPLEVEL_RECORDS = $C0000811;
    ...
    STATUS_FILE_HANDLE_REVOKED = $C0000910;
    ...
    STATUS_INVALID_STATE_TRANSITION = $C000A003;
    ...
    STATUS_INVALID_KERNEL_INFO_VERSION = $C000A004;
    ...
    STATUS_INVALID_PEP_INFO_VERSION = $C000A005;
    ...
    STATUS_EOF_ON_GHOSTED_RANGE = $C000A007;

(*++

 MessageId's $a010 - $a07f (inclusive) are reserved for TCPIP errors.
...
(*++
 ...
 MessageId's $a014 - $a07f (inclusive) are reserved for TCPIP errors.
...
--*)
    ...
    STATUS_INCORRECT_ACCOUNT_TYPE = $C000A089;

(*++

 MessageId's $a100 - $a120 (inclusive) are for the SMB Hash Generation Service.
...
(*++
 ...
 MessageId's $a121 - $a140 (inclusive) are for GPIO (General Purpose I/O) controller related errors.
...
--*)
    ...
    STATUS_SECONDARY_IC_PROVIDER_NOT_REGISTERED = $C000A121;
    ...
    STATUS_GPIO_CLIENT_INFORMATION_INVALID = $C000A122;
    ...
    STATUS_GPIO_VERSION_NOT_SUPPORTED = $C000A123;
    ...
    STATUS_GPIO_INVALID_REGISTRATION_PACKET = $C000A124;
    ...
    STATUS_GPIO_OPERATION_DENIED = $C000A125;
    ...
    STATUS_GPIO_INCOMPATIBLE_CONNECT_MODE = $C000A126;
    ...
    STATUS_GPIO_INTERRUPT_ALREADY_UNMASKED = $8000A127;

(*++

 MessageId's $a141 - $a160 (inclusive) are for run levels support.
...
--*)
    ...
    STATUS_CANNOT_SWITCH_RUNLEVEL = $C000A141;
    ...
    STATUS_INVALID_RUNLEVEL_SETTING = $C000A142;
    ...
    STATUS_RUNLEVEL_SWITCH_TIMEOUT = $C000A143;
    ...
    STATUS_SERVICES_FAILED_AUTOSTART = $4000A144;
    ...
    STATUS_RUNLEVEL_SWITCH_AGENT_TIMEOUT = $C000A145;
    ...
    STATUS_RUNLEVEL_SWITCH_IN_PROGRESS = $C000A146;

(*++

 MessageId's $a200 - $a280 (inclusive) are reserved for app container specific messages.
...
--*)
    ...
    STATUS_NOT_SUPPORTED_IN_APPCONTAINER = $C000A201;
    ...
    STATUS_INVALID_PACKAGE_SID_LENGTH = $C000A202;
    ...
    STATUS_LPAC_ACCESS_DENIED = $C000A203;
    ...
    STATUS_ADMINLESS_ACCESS_DENIED = $C000A204;

(*++

 MessageId's $a281 - $a2a0 (inclusive) are reserved for Fast Cache specific messages.
...
--*)
    ...
    STATUS_APP_DATA_NOT_FOUND = $C000A281;
    ...
    STATUS_APP_DATA_EXPIRED = $C000A282;
    ...
    STATUS_APP_DATA_CORRUPT = $C000A283;
    ...
    STATUS_APP_DATA_LIMIT_EXCEEDED = $C000A284;
    ...
    STATUS_APP_DATA_REBOOT_REQUIRED = $C000A285;

(*++

 MessageId's $a2a1 - $a300 (inclusive) are for File System specific messages.
...
--*)
    ...
    STATUS_WOF_WIM_HEADER_CORRUPT = $C000A2A5;
    ...
    STATUS_WOF_WIM_RESOURCE_TABLE_CORRUPT = $C000A2A6;
    ...
    STATUS_WOF_FILE_RESOURCE_TABLE_CORRUPT = $C000A2A7;

(*++

 MessageId's $ce00 - $ceff (inclusive) are for File System virtualization specific messages.
...
--*)
    ...
    STATUS_FILE_SYSTEM_VIRTUALIZATION_UNAVAILABLE = $C000CE01;
    ...
    STATUS_FILE_SYSTEM_VIRTUALIZATION_METADATA_CORRUPT = $C000CE02;
    ...
    STATUS_FILE_SYSTEM_VIRTUALIZATION_BUSY = $C000CE03;
    ...
    STATUS_FILE_SYSTEM_VIRTUALIZATION_PROVIDER_UNKNOWN = $C000CE04;
    ...
    STATUS_FILE_SYSTEM_VIRTUALIZATION_INVALID_OPERATION = $C000CE05;

(*++

 MessageId's $cf00 - $cfff (inclusive) are for Cloud Files specific messages.
...
--*)
    ...
    STATUS_CLOUD_FILE_SYNC_ROOT_METADATA_CORRUPT = $C000CF00;
    ...
    STATUS_CLOUD_FILE_PROVIDER_NOT_RUNNING = $C000CF01;
    ...
    STATUS_CLOUD_FILE_METADATA_CORRUPT = $C000CF02;
    ...
    STATUS_CLOUD_FILE_METADATA_TOO_LARGE = $C000CF03;
    ...
    STATUS_CLOUD_FILE_PROPERTY_BLOB_TOO_LARGE = $8000CF04;
    ...
    STATUS_CLOUD_FILE_TOO_MANY_PROPERTY_BLOBS = $8000CF05;
    ...
    STATUS_CLOUD_FILE_PROPERTY_VERSION_NOT_SUPPORTED = $C000CF06;
    ...
    STATUS_NOT_A_CLOUD_FILE = $C000CF07;
    ...
    STATUS_CLOUD_FILE_NOT_IN_SYNC = $C000CF08;
    ...
    STATUS_CLOUD_FILE_ALREADY_CONNECTED = $C000CF09;
    ...
    STATUS_CLOUD_FILE_NOT_SUPPORTED = $C000CF0A;
    ...
    STATUS_CLOUD_FILE_INVALID_REQUEST = $C000CF0B;
    ...
    STATUS_CLOUD_FILE_READ_ONLY_VOLUME = $C000CF0C;
    ...
    STATUS_CLOUD_FILE_CONNECTED_PROVIDER_ONLY = $C000CF0D;
    ...
    STATUS_CLOUD_FILE_VALIDATION_FAILED = $C000CF0E;
    ...
    STATUS_CLOUD_FILE_AUTHENTICATION_FAILED = $C000CF0F;
    ...
    STATUS_CLOUD_FILE_INSUFFICIENT_RESOURCES = $C000CF10;
    ...
    STATUS_CLOUD_FILE_NETWORK_UNAVAILABLE = $C000CF11;
    ...
    STATUS_CLOUD_FILE_UNSUCCESSFUL = $C000CF12;
    ...
    STATUS_CLOUD_FILE_NOT_UNDER_SYNC_ROOT = $C000CF13;
    ...
    STATUS_CLOUD_FILE_IN_USE = $C000CF14;
    ...
    STATUS_CLOUD_FILE_PINNED = $C000CF15;
    ...
    STATUS_CLOUD_FILE_REQUEST_ABORTED = $C000CF16;
    ...
    STATUS_CLOUD_FILE_PROPERTY_CORRUPT = $C000CF17;
    ...
    STATUS_CLOUD_FILE_ACCESS_DENIED = $C000CF18;
    ...
    STATUS_CLOUD_FILE_INCOMPATIBLE_HARDLINKS = $C000CF19;
    ...
    STATUS_CLOUD_FILE_PROPERTY_LOCK_CONFLICT = $C000CF1A;
    ...
    STATUS_CLOUD_FILE_REQUEST_CANCELED = $C000CF1B;
    ...
    STATUS_CLOUD_FILE_PROVIDER_TERMINATED = $C000CF1D;
    ...
    STATUS_NOT_A_CLOUD_SYNC_ROOT = $C000CF1E;
...
--*)
    ...
    STATUS_FLT_REGISTRATION_BUSY = $C01C0023;
    ...
    // ToDo {$ifdef (STATUS_SUCCESS) OR (_WIN32_WINNT > $0500) OR (_WIN32_FUSION >= $0100)} // winnt
    ...
    STATUS_SXS_EARLY_DEACTIVATION = $C015000F;    // winnt
    ...
    STATUS_SXS_INVALID_DEACTIVATION = $C0150010;    // winnt
    ...
    STATUS_CLUSTER_CSV_READ_OPLOCK_BREAK_IN_PROGRESS = $C0130020;
    ...
    STATUS_CLUSTER_CSV_REDIRECTED = $C0130022;
    ...
    STATUS_CLUSTER_CSV_NOT_REDIRECTED = $C0130023;
    ...
    STATUS_CLUSTER_CSV_VOLUME_DRAINING = $C0130024;
    ...
    STATUS_CLUSTER_CSV_SNAPSHOT_CREATION_IN_PROGRESS = $C0130025;
    ...
    STATUS_CLUSTER_CSV_VOLUME_DRAINING_SUCCEEDED_DOWNLEVEL = $C0130026;
    ...
    STATUS_CLUSTER_CSV_NO_SNAPSHOTS = $C0130027;
    ...
    STATUS_CSV_IO_PAUSE_TIMEOUT = $C0130028;
    ...
    STATUS_CLUSTER_CSV_INVALID_HANDLE = $C0130029;
    ...
    STATUS_CLUSTER_CSV_SUPPORTED_ONLY_ON_COORDINATOR = $C0130030;
    ...
    STATUS_CLUSTER_CAM_TICKET_REPLAY_DETECTED = $C0130031;
    ...
    //   Common Windows Graphics Kernel Subsystem status codes {$0000..$00ff}
    ...
    STATUS_GRAPHICS_WINDOWDC_NOT_AVAILABLE = $C01E000D;
    ...
    STATUS_GRAPHICS_WINDOWLESS_PRESENT_DISABLED = $C01E000E;


    //   Video Memory Manager (VidMM) specific status codes {$0100..$01ff}
    ...
    //   Video GPU Scheduler (VidSch) specific status codes {$0200..$02ff}
    ...
    STATUS_GRAPHICS_SKIP_ALLOCATION_PREPARATION = $401E0201;


    //   Video Present Network Management (VidPNMgr) specific status codes {$0300..$03ff}
    ...
    //   Port specific status codes {$0400..$04ff}
    ...
    STATUS_GRAPHICS_DEPENDABLE_CHILD_STATUS = $401E043C;


    //   OPM, PVP and UAB status codes {$0500..$057F}
    ...
    //   Monitor Configuration API status codes {$0580..$05DF}
    ...
    //   OPM, UAB, PVP and DDC/CI shared status codes {$25E0..$25FF}
    ...
    STATUS_FVE_FULL_ENCRYPTION_NOT_ALLOWED_ON_TP_STORAGE = $C0210032;
    ...
    STATUS_FVE_WIPE_NOT_ALLOWED_ON_TP_STORAGE = $C0210033;
    ...
    STATUS_FVE_NOT_ALLOWED_ON_CSV_STACK = $C0210034;
    ...
    STATUS_FVE_NOT_ALLOWED_ON_CLUSTER = $C0210035;
    ...
    STATUS_FVE_NOT_ALLOWED_TO_UPGRADE_WHILE_CONVERTING = $C0210036;
    ...
    STATUS_FVE_WIPE_CANCEL_NOT_APPLICABLE = $C0210037;
    ...
    STATUS_FVE_EDRIVE_DRY_RUN_FAILED = $C0210038;
    ...
    STATUS_FVE_SECUREBOOT_DISABLED = $C0210039;
    ...
    STATUS_FVE_SECUREBOOT_CONFIG_CHANGE = $C021003A;
    ...
    STATUS_FVE_DEVICE_LOCKEDOUT = $C021003B;
    ...
    STATUS_FVE_VOLUME_EXTEND_PREVENTS_EOW_DECRYPT = $C021003C;
    ...
    STATUS_FVE_NOT_DE_VOLUME = $C021003D;
    ...
    STATUS_FVE_PROTECTION_DISABLED = $C021003E;
    ...
    STATUS_FVE_PROTECTION_CANNOT_BE_DISABLED = $C021003F;
    ...
    STATUS_FVE_OSV_KSR_NOT_ALLOWED = $C0210040;
    ...
    STATUS_FWP_INVALID_TUNNEL_ENDPOINT = $C022003D;
    ...
    STATUS_FWP_L2_DRIVER_NOT_READY = $C022003E;
    ...
    STATUS_FWP_KEY_DICTATOR_ALREADY_REGISTERED = $C022003F;
    ...
    STATUS_FWP_KEY_DICTATION_INVALID_KEYING_MATERIAL = $C0220040;
    ...
    STATUS_FWP_CONNECTIONS_DISABLED = $C0220041;
    ...
    STATUS_FWP_INVALID_DNS_NAME = $C0220042;
    ...
    STATUS_FWP_IKEEXT_NOT_RUNNING = $C0220044;
    ...
    STATUS_NDIS_REINIT_REQUIRED = $C0230030;
    ...
    STATUS_NDIS_DOT11_AP_CHANNEL_CURRENTLY_NOT_AVAILABLE = $C0232005;
    ...
    STATUS_NDIS_DOT11_AP_BAND_CURRENTLY_NOT_AVAILABLE = $C0232006;
    ...
    STATUS_NDIS_DOT11_AP_CHANNEL_NOT_ALLOWED = $C0232007;
    ...
    STATUS_NDIS_DOT11_AP_BAND_NOT_ALLOWED = $C0232008;
    ...
    // TPM hardware errors {$0000..$003ff}
    ...
    STATUS_TPM_ERROR_MASK = $C0290000;
    ...
    STATUS_TPM_BAD_PARAMETER = $C0290003;
    ...
    STATUS_TPM_AUDITFAILURE = $C0290004;
    ...
    STATUS_TPM_CLEAR_DISABLED = $C0290005;
    ...
    STATUS_TPM_DEACTIVATED = $C0290006;
    ...
    STATUS_TPM_DISABLED_CMD = $C0290008;
    ...
    STATUS_TPM_BAD_ORDINAL = $C029000A;
    ...
    STATUS_TPM_INSTALL_DISABLED = $C029000B;
    ...
    STATUS_TPM_INVALID_KEYHANDLE = $C029000C;
    ...
    STATUS_TPM_KEYNOTFOUND = $C029000D;
    ...
    STATUS_TPM_INAPPROPRIATE_ENC = $C029000E;
    ...
    STATUS_TPM_MIGRATEFAIL = $C029000F;
    ...
    STATUS_TPM_INVALID_PCR_INFO = $C0290010;
    ...
    STATUS_TPM_NOTSEALED_BLOB = $C0290013;
    ...
    STATUS_TPM_SHORTRANDOM = $C0290016;
    ...
    STATUS_TPM_WRONGPCRVAL = $C0290018;
    ...
    STATUS_TPM_BAD_PARAM_SIZE = $C0290019;
    ...
    STATUS_TPM_SHA_THREAD = $C029001A;
    ...
    STATUS_TPM_FAILEDSELFTEST = $C029001C;
    ...
    STATUS_TPM_ENCRYPT_ERROR = $C0290020;
    ...
    STATUS_TPM_DECRYPT_ERROR = $C0290021;
    ...
    STATUS_TPM_INVALID_AUTHHANDLE = $C0290022;
    ...
    STATUS_TPM_NO_ENDORSEMENT = $C0290023;
    ...
    STATUS_TPM_INVALID_KEYUSAGE = $C0290024;
    ...
    STATUS_TPM_WRONG_ENTITYTYPE = $C0290025;
    ...
    STATUS_TPM_INVALID_POSTINIT = $C0290026;
    ...
    STATUS_TPM_INAPPROPRIATE_SIG = $C0290027;
    ...
    STATUS_TPM_BAD_KEY_PROPERTY = $C0290028;
    ...
    STATUS_TPM_BAD_MIGRATION = $C0290029;
    ...
    STATUS_TPM_BAD_SCHEME = $C029002A;
    ...
    STATUS_TPM_BAD_DATASIZE = $C029002B;
    ...
    STATUS_TPM_BAD_PRESENCE = $C029002D;
    ...
    STATUS_TPM_BAD_VERSION = $C029002E;
    ...
    STATUS_TPM_NO_WRAP_TRANSPORT = $C029002F;
    ...
    STATUS_TPM_AUDITFAIL_UNSUCCESSFUL = $C0290030;
    ...
    STATUS_TPM_AUDITFAIL_SUCCESSFUL = $C0290031;
    ...
    STATUS_TPM_NOTRESETABLE = $C0290032;
    ...
    STATUS_TPM_INVALID_RESOURCE = $C0290035;
    ...
    STATUS_TPM_INVALID_FAMILY = $C0290037;
    ...
    STATUS_TPM_NO_NV_PERMISSION = $C0290038;
    ...
    STATUS_TPM_REQUIRES_SIGN = $C0290039;
    ...
    STATUS_TPM_KEY_NOTSUPPORTED = $C029003A;
    ...
    STATUS_TPM_AUTH_CONFLICT = $C029003B;
    ...
    STATUS_TPM_AREA_LOCKED = $C029003C;
    ...
    STATUS_TPM_BAD_LOCALITY = $C029003D;
    ...
    STATUS_TPM_PER_NOWRITE = $C029003F;
    ...
    STATUS_TPM_FAMILYCOUNT = $C0290040;
    ...
    STATUS_TPM_WRITE_LOCKED = $C0290041;
    ...
    STATUS_TPM_BAD_ATTRIBUTES = $C0290042;
    ...
    STATUS_TPM_INVALID_STRUCTURE = $C0290043;
    ...
    STATUS_TPM_KEY_OWNER_CONTROL = $C0290044;
    ...
    STATUS_TPM_BAD_COUNTER = $C0290045;
    ...
    STATUS_TPM_NOT_FULLWRITE = $C0290046;
    ...
    STATUS_TPM_CONTEXT_GAP = $C0290047;
    ...
    STATUS_TPM_MAXNVWRITES = $C0290048;
    ...
    STATUS_TPM_NOOPERATOR = $C0290049;
    ...
    STATUS_TPM_RESOURCEMISSING = $C029004A;
    ...
    STATUS_TPM_DELEGATE_LOCK = $C029004B;
    ...
    STATUS_TPM_DELEGATE_FAMILY = $C029004C;
    ...
    STATUS_TPM_DELEGATE_ADMIN = $C029004D;
    ...
    STATUS_TPM_TRANSPORT_NOTEXCLUSIVE = $C029004E;
    ...
    STATUS_TPM_OWNER_CONTROL = $C029004F;
    ...
    STATUS_TPM_DAA_RESOURCES = $C0290050;
    ...
    STATUS_TPM_DAA_INPUT_DATA0 = $C0290051;
    ...
    STATUS_TPM_DAA_INPUT_DATA1 = $C0290052;
    ...
    STATUS_TPM_DAA_ISSUER_SETTINGS = $C0290053;
    ...
    STATUS_TPM_DAA_TPM_SETTINGS = $C0290054;
    ...
    STATUS_TPM_DAA_ISSUER_VALIDITY = $C0290056;
    ...
    STATUS_TPM_DAA_WRONG_W = $C0290057;
    ...
    STATUS_TPM_BAD_HANDLE = $C0290058;
    ...
    STATUS_TPM_BAD_DELEGATE = $C0290059;
    ...
    STATUS_TPM_BADCONTEXT = $C029005A;
    ...
    STATUS_TPM_TOOMANYCONTEXTS = $C029005B;
    ...
    STATUS_TPM_MA_TICKET_SIGNATURE = $C029005C;
    ...
    STATUS_TPM_MA_DESTINATION = $C029005D;
    ...
    STATUS_TPM_MA_AUTHORITY = $C029005F;
    ...
    STATUS_TPM_PERMANENTEK = $C0290061;
    ...
    STATUS_TPM_BAD_SIGNATURE = $C0290062;
    ...
    STATUS_TPM_NOCONTEXTSPACE = $C0290063;
    ...
    STATUS_TPM_COMMAND_BLOCKED = $C0290400;
    ...
    STATUS_TPM_INVALID_HANDLE = $C0290401;
    ...
    STATUS_TPM_DUPLICATE_VHANDLE = $C0290402;
    ...
    STATUS_TPM_EMBEDDED_COMMAND_BLOCKED = $C0290403;
    ...
    STATUS_TPM_EMBEDDED_COMMAND_UNSUPPORTED = $C0290404;
    ...
    STATUS_TPM_NEEDS_SELFTEST = $C0290801;
    ...
    STATUS_TPM_DOING_SELFTEST = $C0290802;
    ...
    STATUS_TPM_DEFEND_LOCK_RUNNING = $C0290803;
    ...
    STATUS_TPM_COMMAND_CANCELED = $C0291001;
    ...
    STATUS_TPM_TOO_MANY_CONTEXTS = $C0291002;
    ...
    STATUS_TPM_ACCESS_DENIED = $C0291004;
    ...
    STATUS_TPM_INSUFFICIENT_BUFFER = $C0291005;
    ...
    STATUS_TPM_PPI_FUNCTION_UNSUPPORTED = $C0291006;
    ...
    STATUS_PCP_ERROR_MASK = $C0292000;
    ...
    STATUS_PCP_DEVICE_NOT_READY = $C0292001;
    ...
    STATUS_PCP_INVALID_HANDLE = $C0292002;
    ...
    STATUS_PCP_INVALID_PARAMETER = $C0292003;
    ...
    STATUS_PCP_FLAG_NOT_SUPPORTED = $C0292004;
    ...
    STATUS_PCP_NOT_SUPPORTED = $C0292005;
    ...
    STATUS_PCP_BUFFER_TOO_SMALL = $C0292006;
    ...
    STATUS_PCP_INTERNAL_ERROR = $C0292007;
    ...
    STATUS_PCP_AUTHENTICATION_FAILED = $C0292008;
    ...
    STATUS_PCP_AUTHENTICATION_IGNORED = $C0292009;
    ...
    STATUS_PCP_POLICY_NOT_FOUND = $C029200A;
    ...
    STATUS_PCP_PROFILE_NOT_FOUND = $C029200B;
    ...
    STATUS_PCP_VALIDATION_FAILED = $C029200C;
    ...
    STATUS_PCP_DEVICE_NOT_FOUND = $C029200D;
    ...
    STATUS_PCP_WRONG_PARENT = $C029200E;
    ...
    STATUS_PCP_KEY_NOT_LOADED = $C029200F;
    ...
    STATUS_PCP_NO_KEY_CERTIFICATION = $C0292010;
    ...
    STATUS_PCP_KEY_NOT_FINALIZED = $C0292011;
    ...
    STATUS_PCP_ATTESTATION_CHALLENGE_NOT_SET = $C0292012;
    ...
    STATUS_PCP_NOT_PCR_BOUND = $C0292013;
    ...
    STATUS_PCP_KEY_ALREADY_FINALIZED = $C0292014;
    ...
    STATUS_PCP_KEY_USAGE_POLICY_NOT_SUPPORTED = $C0292015;
    ...
    STATUS_PCP_KEY_USAGE_POLICY_INVALID = $C0292016;
    ...
    STATUS_PCP_SOFT_KEY_ERROR = $C0292017;
    ...
    STATUS_PCP_KEY_NOT_AUTHENTICATED = $C0292018;
    ...
    STATUS_PCP_KEY_NOT_AIK = $C0292019;
    ...
    STATUS_PCP_KEY_NOT_SIGNING_KEY = $C029201A;
    ...
    STATUS_PCP_LOCKED_OUT = $C029201B;
    ...
    STATUS_PCP_CLAIM_TYPE_NOT_SUPPORTED = $C029201C;
    ...
    STATUS_PCP_TPM_VERSION_NOT_SUPPORTED = $C029201D;
    ...
    STATUS_PCP_BUFFER_LENGTH_MISMATCH = $C029201E;
    ...
    STATUS_PCP_IFX_RSA_KEY_CREATION_BLOCKED = $C029201F;
    ...
    STATUS_PCP_TICKET_MISSING = $C0292020;
    ...
    STATUS_PCP_RAW_POLICY_NOT_SUPPORTED = $C0292021;
    ...
    STATUS_RTPM_CONTEXT_CONTINUE = $00293000;
    ...
    STATUS_RTPM_CONTEXT_COMPLETE = $00293001;
    ...
    STATUS_RTPM_NO_RESULT = $C0293002;
    ...
    STATUS_RTPM_PCR_READ_INCOMPLETE = $C0293003;
    ...
    STATUS_RTPM_INVALID_CONTEXT = $C0293004;
    ...
    STATUS_RTPM_UNSUPPORTED_CMD = $C0293005;
    ...
    STATUS_TPM_ZERO_EXHAUST_ENABLED = $C0294000;
    ...
    STATUS_HV_INVALID_VP_STATE = $C0350015;
    ...
    STATUS_HV_INSUFFICIENT_BUFFER = $C0350033;
    ...
    STATUS_HV_INSUFFICIENT_DEVICE_DOMAINS = $C0350038;
    ...
    STATUS_HV_CPUID_FEATURE_VALIDATION_ERROR = $C035003C;
    ...
    STATUS_HV_CPUID_XSAVE_FEATURE_VALIDATION_ERROR = $C035003D;
    ...
    STATUS_HV_PROCESSOR_STARTUP_TIMEOUT = $C035003E;
    ...
    STATUS_HV_SMX_ENABLED = $C035003F;
    ...
    STATUS_HV_INVALID_LP_INDEX = $C0350041;
    ...
    STATUS_HV_INVALID_REGISTER_VALUE = $C0350050;
    ...
    STATUS_HV_INVALID_VTL_STATE = $C0350051;
    ...
    STATUS_HV_NX_NOT_DETECTED = $C0350055;
    ...
    STATUS_HV_INVALID_DEVICE_ID = $C0350057;
    ...
    STATUS_HV_INVALID_DEVICE_STATE = $C0350058;
    ...
    STATUS_HV_PENDING_PAGE_REQUESTS = $00350059;
    ...
    STATUS_HV_PAGE_REQUEST_INVALID = $C0350060;
    ...
    STATUS_HV_INVALID_CPU_GROUP_ID = $C035006F;
    ...
    STATUS_HV_INVALID_CPU_GROUP_STATE = $C0350070;
    ...
    STATUS_HV_OPERATION_FAILED = $C0350071;
    ...
    STATUS_HV_NOT_ALLOWED_WITH_NESTED_VIRT_ACTIVE = $C0350072;
    ...
    STATUS_VID_VTL_ACCESS_DENIED = $C037002A;
    ...
    STATUS_VIRTDISK_DISK_ALREADY_OWNED = $C03A001E;
    ...
    STATUS_VIRTDISK_DISK_ONLINE_AND_WRITABLE = $C03A001F;
    ...
    STATUS_CTLOG_TRACKING_NOT_INITIALIZED = $C03A0020;
    ...
    STATUS_CTLOG_LOGFILE_SIZE_EXCEEDED_MAXSIZE = $C03A0021;
    ...
    STATUS_CTLOG_VHD_CHANGED_OFFLINE = $C03A0022;
    ...
    STATUS_CTLOG_INVALID_TRACKING_STATE = $C03A0023;
    ...
    STATUS_CTLOG_INCONSISTENT_TRACKING_FILE = $C03A0024;
    ...
    STATUS_VHD_METADATA_FULL = $C03A0028;
    ...
    STATUS_VHD_INVALID_CHANGE_TRACKING_ID = $C03A0029;
    ...
    STATUS_VHD_CHANGE_TRACKING_DISABLED = $C03A002A;
    ...
    STATUS_VHD_MISSING_CHANGE_TRACKING_INFORMATION = $C03A0030;
    ...
    STATUS_VHD_RESIZE_WOULD_TRUNCATE_DATA = $C03A0031;
    ...
    STATUS_VHD_COULD_NOT_COMPUTE_MINIMUM_VIRTUAL_SIZE = $C03A0032;
    ...
    STATUS_VHD_ALREADY_AT_OR_BELOW_MINIMUM_VIRTUAL_SIZE = $C03A0033;
    ...
    STATUS_GDI_HANDLE_LEAK = $803F0001;
    ...
    STATUS_RKF_KEY_NOT_FOUND = $C0400001;
    ...
    STATUS_RKF_DUPLICATE_KEY = $C0400002;
    ...
    STATUS_RKF_STORE_FULL = $C0400004;
    ...
    STATUS_RKF_FILE_BLOCKED = $C0400005;
    ...
    STATUS_RKF_ACTIVE_KEY = $C0400006;
    ...
    STATUS_RDBSS_RESTART_OPERATION = $C0410001;
    ...
    STATUS_RDBSS_CONTINUE_OPERATION = $C0410002;
    ...
    STATUS_RDBSS_POST_OPERATION = $C0410003;
    ...
    STATUS_RDBSS_RETRY_LOOKUP = $C0410004;
    ...
    STATUS_BTH_ATT_INVALID_HANDLE = $C0420001;
    ...
    STATUS_BTH_ATT_READ_NOT_PERMITTED = $C0420002;
    ...
    STATUS_BTH_ATT_WRITE_NOT_PERMITTED = $C0420003;
    ...
    STATUS_BTH_ATT_INVALID_PDU = $C0420004;
    ...
    STATUS_BTH_ATT_INSUFFICIENT_AUTHENTICATION = $C0420005;
    ...
    STATUS_BTH_ATT_REQUEST_NOT_SUPPORTED = $C0420006;
    ...
    STATUS_BTH_ATT_INVALID_OFFSET = $C0420007;
    ...
    STATUS_BTH_ATT_INSUFFICIENT_AUTHORIZATION = $C0420008;
    ...
    STATUS_BTH_ATT_PREPARE_QUEUE_FULL = $C0420009;
    ...
    STATUS_BTH_ATT_ATTRIBUTE_NOT_FOUND = $C042000A;
    ...
    STATUS_BTH_ATT_ATTRIBUTE_NOT_LONG = $C042000B;
    ...
    STATUS_BTH_ATT_INSUFFICIENT_ENCRYPTION_KEY_SIZE = $C042000C;
    ...
    STATUS_BTH_ATT_INVALID_ATTRIBUTE_VALUE_LENGTH = $C042000D;
    ...
    STATUS_BTH_ATT_UNLIKELY = $C042000E;
    ...
    STATUS_BTH_ATT_INSUFFICIENT_ENCRYPTION = $C042000F;
    ...
    STATUS_BTH_ATT_UNSUPPORTED_GROUP_TYPE = $C0420010;
    ...
    STATUS_BTH_ATT_INSUFFICIENT_RESOURCES = $C0420011;
    ...
    STATUS_BTH_ATT_UNKNOWN_ERROR = $C0421000;
    ...
    STATUS_SECUREBOOT_ROLLBACK_DETECTED = $C0430001;
    ...
    STATUS_SECUREBOOT_POLICY_VIOLATION = $C0430002;
    ...
    STATUS_SECUREBOOT_INVALID_POLICY = $C0430003;
    ...
    STATUS_SECUREBOOT_POLICY_PUBLISHER_NOT_FOUND = $C0430004;
    ...
    STATUS_SECUREBOOT_POLICY_NOT_SIGNED = $C0430005;
    ...
    STATUS_SECUREBOOT_NOT_ENABLED = $80430006;
    ...
    STATUS_SECUREBOOT_FILE_REPLACED = $C0430007;
    ...
    STATUS_SECUREBOOT_POLICY_NOT_AUTHORIZED = $C0430008;
    ...
    STATUS_SECUREBOOT_POLICY_UNKNOWN = $C0430009;
    ...
    STATUS_SECUREBOOT_POLICY_MISSING_ANTIROLLBACKVERSION = $C043000A;
    ...
    STATUS_SECUREBOOT_PLATFORM_ID_MISMATCH = $C043000B;
    ...
    STATUS_SECUREBOOT_POLICY_ROLLBACK_DETECTED = $C043000C;
    ...
    STATUS_SECUREBOOT_POLICY_UPGRADE_MISMATCH = $C043000D;
    ...
    STATUS_SECUREBOOT_REQUIRED_POLICY_FILE_MISSING = $C043000E;
    ...
    STATUS_SECUREBOOT_NOT_BASE_POLICY = $C043000F;
    ...
    STATUS_SECUREBOOT_NOT_SUPPLEMENTAL_POLICY = $C0430010;
    ...
    STATUS_PLATFORM_MANIFEST_NOT_AUTHORIZED = $C0EB0001;
    ...
    STATUS_PLATFORM_MANIFEST_INVALID = $C0EB0002;
    ...
    STATUS_PLATFORM_MANIFEST_FILE_NOT_AUTHORIZED = $C0EB0003;
    ...
    STATUS_PLATFORM_MANIFEST_CATALOG_NOT_AUTHORIZED = $C0EB0004;
    ...
    STATUS_PLATFORM_MANIFEST_BINARY_ID_NOT_FOUND = $C0EB0005;
    ...
    STATUS_PLATFORM_MANIFEST_NOT_ACTIVE = $C0EB0006;
    ...
    STATUS_PLATFORM_MANIFEST_NOT_SIGNED = $C0EB0007;
    ...
    STATUS_SYSTEM_INTEGRITY_ROLLBACK_DETECTED = $C0E90001;
    ...
    STATUS_SYSTEM_INTEGRITY_POLICY_VIOLATION = $C0E90002;
    ...
    STATUS_SYSTEM_INTEGRITY_INVALID_POLICY = $C0E90003;
    ...
    STATUS_SYSTEM_INTEGRITY_POLICY_NOT_SIGNED = $C0E90004;
    ...
    STATUS_NO_APPLICABLE_APP_LICENSES_FOUND = $C0EA0001;
    ...
    STATUS_CLIP_LICENSE_NOT_FOUND = $C0EA0002;
    ...
    STATUS_CLIP_DEVICE_LICENSE_MISSING = $C0EA0003;
    ...
    STATUS_CLIP_LICENSE_INVALID_SIGNATURE = $C0EA0004;
    ...
    STATUS_CLIP_KEYHOLDER_LICENSE_MISSING_OR_INVALID = $C0EA0005;
    ...
    STATUS_CLIP_LICENSE_EXPIRED = $C0EA0006;
    ...
    STATUS_CLIP_LICENSE_SIGNED_BY_UNKNOWN_SOURCE = $C0EA0007;
    ...
    STATUS_CLIP_LICENSE_NOT_SIGNED = $C0EA0008;
    ...
    STATUS_CLIP_LICENSE_HARDWARE_ID_OUT_OF_TOLERANCE = $C0EA0009;
    ...
    STATUS_CLIP_LICENSE_DEVICE_ID_MISMATCH = $C0EA000A;
    ...
    STATUS_AUDIO_ENGINE_NODE_NOT_FOUND = $C0440001;
    ...
    STATUS_HDAUDIO_EMPTY_CONNECTION_LIST = $C0440002;
    ...
    STATUS_HDAUDIO_CONNECTION_LIST_NOT_SUPPORTED = $C0440003;
    ...
    STATUS_HDAUDIO_NO_LOGICAL_DEVICES_CREATED = $C0440004;
    ...
    STATUS_HDAUDIO_NULL_LINKED_LIST_ENTRY = $C0440005;
    ...
    STATUS_SPACES_REPAIRED = $00E70000;
    ...
    STATUS_SPACES_COMPLETE = $00E70002;
    ...
    STATUS_SPACES_REDIRECT = $00E70003;
    ...
    STATUS_SPACES_FAULT_DOMAIN_TYPE_INVALID = $C0E70001;
    ...
    STATUS_SPACES_RESILIENCY_TYPE_INVALID = $C0E70003;
    ...
    STATUS_SPACES_DRIVE_SECTOR_SIZE_INVALID = $C0E70004;
    ...
    STATUS_SPACES_DRIVE_REDUNDANCY_INVALID = $C0E70006;
    ...
    STATUS_SPACES_NUMBER_OF_DATA_COPIES_INVALID = $C0E70007;
    ...
    STATUS_SPACES_INTERLEAVE_LENGTH_INVALID = $C0E70009;
    ...
    STATUS_SPACES_NUMBER_OF_COLUMNS_INVALID = $C0E7000A;
    ...
    STATUS_SPACES_NOT_ENOUGH_DRIVES = $C0E7000B;
    ...
    STATUS_SPACES_EXTENDED_ERROR = $C0E7000C;
    ...
    STATUS_SPACES_PROVISIONING_TYPE_INVALID = $C0E7000D;
    ...
    STATUS_SPACES_ALLOCATION_SIZE_INVALID = $C0E7000E;
    ...
    STATUS_SPACES_ENCLOSURE_AWARE_INVALID = $C0E7000F;
    ...
    STATUS_SPACES_WRITE_CACHE_SIZE_INVALID = $C0E70010;
    ...
    STATUS_SPACES_NUMBER_OF_GROUPS_INVALID = $C0E70011;
    ...
    STATUS_SPACES_DRIVE_OPERATIONAL_STATE_INVALID = $C0E70012;
    ...
    STATUS_SPACES_UPDATE_COLUMN_STATE = $C0E70013;
    ...
    STATUS_SPACES_MAP_REQUIRED = $C0E70014;
    ...
    STATUS_SPACES_UNSUPPORTED_VERSION = $C0E70015;
    ...
    STATUS_SPACES_CORRUPT_METADATA = $C0E70016;
    ...
    STATUS_SPACES_DRT_FULL = $C0E70017;
    ...
    STATUS_SPACES_INCONSISTENCY = $C0E70018;
    ...
    STATUS_SPACES_LOG_NOT_READY = $C0E70019;
    ...
    STATUS_SPACES_NO_REDUNDANCY = $C0E7001A;
    ...
    STATUS_SPACES_DRIVE_NOT_READY = $C0E7001B;
    ...
    STATUS_SPACES_DRIVE_SPLIT = $C0E7001C;
    ...
    STATUS_SPACES_DRIVE_LOST_DATA = $C0E7001D;
    ...
    STATUS_VOLSNAP_BOOTFILE_NOT_VALID = $C0500003;
    ...
    STATUS_VOLSNAP_ACTIVATION_TIMEOUT = $C0500004;
    ...
    STATUS_SVHDX_ERROR_STORED = $C05C0000;
    ...
    STATUS_SVHDX_ERROR_NOT_AVAILABLE = $C05CFF00;
    ...
    STATUS_SVHDX_UNIT_ATTENTION_AVAILABLE = $C05CFF01;
    ...
    STATUS_SVHDX_UNIT_ATTENTION_CAPACITY_DATA_CHANGED = $C05CFF02;
    ...
    STATUS_SVHDX_UNIT_ATTENTION_RESERVATIONS_PREEMPTED = $C05CFF03;
    ...
    STATUS_SVHDX_UNIT_ATTENTION_RESERVATIONS_RELEASED = $C05CFF04;
    ...
    STATUS_SVHDX_UNIT_ATTENTION_REGISTRATIONS_PREEMPTED = $C05CFF05;
    ...
    STATUS_SVHDX_UNIT_ATTENTION_OPERATING_DEFINITION_CHANGED = $C05CFF06;
    ...
    STATUS_SVHDX_RESERVATION_CONFLICT = $C05CFF07;
    ...
    STATUS_SVHDX_WRONG_FILE_TYPE = $C05CFF08;
    ...
    STATUS_SVHDX_VERSION_MISMATCH = $C05CFF09;
    ...
    STATUS_SVHDX_NO_INITIATOR = $C05CFF0B;
    ...
    STATUS_VHDSET_BACKING_STORAGE_NOT_FOUND = $C05CFF0C;
    ...
    STATUS_SMB_NO_PREAUTH_INTEGRITY_HASH_OVERLAP = $C05D0000;
    ...
    STATUS_SMB_BAD_CLUSTER_DIALECT = $C05D0001;
    ...
    STATUS_SMB_GUEST_LOGON_BLOCKED = $C05D0002;
    ...
    STATUS_SECCORE_INVALID_COMMAND = $C0E80000;
    ...
    STATUS_VSM_NOT_INITIALIZED = $C0450000;
    ...
    STATUS_VSM_DMA_PROTECTION_NOT_IN_USE = $C0450001;
    ...
    STATUS_APPEXEC_CONDITION_NOT_SATISFIED = $C0EC0000;
    ...
    STATUS_APPEXEC_HANDLE_INVALIDATED = $C0EC0001;
    ...
    STATUS_APPEXEC_INVALID_HOST_GENERATION = $C0EC0002;
    ...
    STATUS_APPEXEC_UNEXPECTED_PROCESS_REGISTRATION = $C0EC0003;
    ...
    STATUS_APPEXEC_INVALID_HOST_STATE = $C0EC0004;
    ...
    STATUS_APPEXEC_NO_DONOR = $C0EC0005;
    ...
    STATUS_APPEXEC_HOST_ID_MISMATCH = $C0EC0006;
